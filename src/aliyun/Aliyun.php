...
class Aliyun
{
     ...
     * @return stdClass
     */
    public static function sendMobileMes($signName, $templateCode, $phoneNumbers, $key,$secret,$templateParam = null, $outId = null) {
	...
	return json_encode($acsResponse,JSON_UNESCAPED_UNICODE);
     ...
     * @return stdClass
     */
    public static  function queryMobileMes($phoneNumbers, $sendDate,$key,$secret, $pageSize = 10, $currentPage = 1, $bizId=null) {
